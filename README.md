# ThreeJSDemo
This repository contains a ThreeJS demo program which tests using verticies, lines and wireframes, importing textures and models, as well as experimenting with lighting and physics

In order to run this demo you must access ThreeJSDemo.html through an http address. The most straightforward way to do this is by running:

python -m http.server

in your terminal, and then navigating to the address shown in the terminal to search for the file
